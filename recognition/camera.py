...
oo = os.path.sep.join([settings.BASE_DIR])
...
# load our serialized face detec
# tor model from dis


protoPath = os.path.sep.join([settings.BASE_DIR, "Attendence_projcet/face_detection_model\deploy.prototxt"])
modelPath = os.path.sep.join([settings.BASE_DIR,"Attendence_projcet/face_detection_model\res10_300x300_ssd_iter_140000.caffemodel"])
detector = cv2.dnn.readNetFromCaffe(modelPath,protoPath)
